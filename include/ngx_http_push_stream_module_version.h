...
static const ngx_str_t  NGX_HTTP_PUSH_STREAM_TAG = ngx_string("0.5.2");
static const ngx_str_t  NGX_HTTP_PUSH_STREAM_COMMIT = ngx_string("f3a02962363e55f4653952875f02da1e6ba293bb");
